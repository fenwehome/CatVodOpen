...
async function home(filter) {
    let classes = [{'type_id': 1, 'type_name' : '电影'},{'type_id': 2, 'type_name' : '国产剧集'},{'type_id': 21, 'type_name' : '日韩剧集'},{'type_id': 22, 'type_name' : '欧美剧集'},{'type_id': 4, 'type_name' : '动漫'},{'type_id': 3, 'type_name' : '综艺'}];
    let filterObj = {
