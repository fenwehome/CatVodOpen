...
let siteKey = 'sigequan';
let siteType = 0;
let siteUrl = 'https://pg.fenwe.eu.org';
...
let classes = [{'type_id': 1, 'type_name' : '电影'},{'type_id': 2, 'type_name' : '剧集'},{'type_id': 4, 'type_name' : '动漫'},{'type_id': 3, 'type_name' : '综艺'}];
let filterObj = {};
